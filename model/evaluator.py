...
class QuantizedEvaluator:
    ...
    def check_model_quantization(self):
        ...
        policy_model = self.model_class.from_pretrained(
            self.policy_model_path, **self.policy_model_args
        )
        ...
        quantized_model = self.model_class.from_pretrained(
            self.quantized_model_path, **self.quantized_model_args
        )
        quantized_model_footprint = (
            quantized_model.pretrained_model.get_memory_footprint()
        )
        del quantized_model
        ...
        for method in eval_method:
            if method == "rag":
                ...
                evaluator = RAGModelEvaluator(
                    task_type, rag_policy_model_path, rag_model_args
                )
                ...
                quantized_size, orig_size, quantized = (
